                        ...
                        <div class="action">
                            <div class="actions_inner">
                                <ul class="add_to_links">
                                    <li><a class="cart d-flex justify-content-center align-items-center" href="cart.html"><i class="bi bi-shopping-bag4"></i></a>
                                    </li>
                                ...
                                <div class="single__product__inner">
                                    <div class="product product__style--3">
                                        ...
                                        <div class="product__content content--center content--center">
                                            <h4><a href="single-product.html">${single_product.product_name}</a></h4>
                                            <ul class="price d-flex">
...
<%--        </div>--%>
<%--    </div>--%>
<%--    <div class="slider center best-sale">--%>
