                            ...
                            <div class="margin_between">
                                <div class="input_box space_between">
                                    ...
                                    <spForm:input value="${cart.user.phone_number}"  placeholder="Phone"
                                                  path="user.phone_number" type="tel" required="required"/>
                                </div>
                            ...
                            <li>Shipping
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <label>Giao bình thường: 30.000 VND</label>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="total__amount">
                            <li>Tiền hàng <span id="sub_total">$223.00</span></li>
...
<script>
    ...
    function processTotal() {
        ...
        listPrice.forEach((val, index) => {
            subtotal += parseInt(val.textContent.replace(".000 VND", "").trim().slice(0, val.textContent.length - 3))
            amount += parseInt(val.textContent.replace(".000 VND", "").trim().slice(0, val.textContent.length - 3))
        })
        document.getElementById("sub_total").textContent =  subtotal + '.000 VND'
        document.getElementById("order-total").textContent =    amount + ".000 VND";
    }
    processTotal()
</script>
<!-- End Checkout Area -->