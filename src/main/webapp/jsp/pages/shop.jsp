                    ...
                    <div class="col-lg-12">
                        <div
                            ...
                            <div class="shop__list nav justify-content-center" role="tablist">
                                <a class="nav-item nav-link active d-flex justify-content-center align-items-center" data-bs-toggle="tab" href="#nav-grid" role="tab"><i
                                        class="fa fa-th"></i></a>
                                <a class="nav-item nav-link  d-flex justify-content-center align-items-center" data-bs-toggle="tab" href="#nav-list"
                                   role="tab"><i class="fa fa-list"></i></a>
                            </div>
                            <p>Showing ${data.productViewDtoList.getContent().size()} of ${data.productViewDtoList.getTotalElements()} results</p>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="${pageContext.request.contextPath}/products/${product.slug}"><img
                                               style="height: 300px;object-fit:cover;" src="${pageContext.request.contextPath}${product.images_con.get(0).path}" alt="product image"></a>
                                        <a class="second__img animation1" href="${pageContext.request.contextPath}/products/${product.slug}"><img
                                                style="height: 300px;object-fit:cover;" src="${pageContext.request.contextPath}${product.images_con.get(1).path}" alt="product image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">BEST SALLER</span>
                                        </div>
                                    </div>
                                    <div class="product__content content--center">
                                        <h4><a href="${pageContext.request.contextPath}/products/${product.slug}">${product.product_name}</a></h4>
                                ...
                                <div class="list__view mt--40">
                                    <div class="thumb">
                                        <a class="first__img" href="${pageContext.request.contextPath}/products/${product_list.slug}"><img
                                                src="${pageContext.request.contextPath}${product_list.images_con.get(0).path}" alt="product images"></a>
                                        <a class="second__img animation1" href="${pageContext.request.contextPath}/products/${product_list.slug}"><img
                                                src="${pageContext.request.contextPath}${product_list.images_con.get(0).path}" alt="product images"></a>
                                    </div>
                                    <div class="content">
                                        <h2><a href="${pageContext.request.contextPath}/products/${product_list.slug}">${product_list.product_name}</a></h2>
                                        <ul class="rating d-flex">
                                            <li class="on"><i class="fa fa-star-o"></i></li>
                                            <li class="on"><i class="fa fa-star-o"></i></li>
                                            <li class="on"><i class="fa fa-star-o"></i></li>
